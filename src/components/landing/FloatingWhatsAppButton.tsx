...
export function FloatingWhatsAppButton() {
  ...
  return (
    <Button
      asChild
      className="fixed bottom-6 right-6 z-50 h-16 w-16 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center bg-transparent hover:bg-transparent"
      size="icon"
